...
const navLinkClass = ({isActive}: { isActive: boolean }) =>
    `rounded-md px-3 py-2 text-sm font-medium transition ${
        isActive ? "bg-blue-100 text-blue-800" : "text-gray-700 hover:bg-gray-100 hover:text-gray-900"
    }`;

const aboutItems = [
    {label: "About School", to: "/about"},
    // {label: "Mission", to: "/about/mission"},
    {label: "School Team", to: "/team"},
];
    ...
    return (
        <header className="sticky top-0 z-50 border-b border-gray-200 bg-white/95 backdrop-blur">
            ...
            <div className="mx-auto flex h-16 w-full max-w-7xl items-center px-4 sm:px-6 lg:px-8">
                ...
                >
                    [Shree Jwala Secondary School Logo]
                ...
                <div className="ml-8 hidden items-center gap-1 md:flex">
                    ...
                    {/* ABOUT DROPDOWN (NOW RIGHT AFTER HOME) */}
                    <div className="relative">
                        ...
                        {aboutOpen && (
                            <div
                                className="absolute left-0 top-full mt-2 w-44 rounded-md border border-gray-200 bg-white p-1 shadow-lg z-50">
                                {aboutItems.map((item) => (
                                    <NavLink
                                        key={item.to}
                                        to={item.to}
